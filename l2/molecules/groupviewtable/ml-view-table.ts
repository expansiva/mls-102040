...
export class ViewTableMolecule extends MoleculeAuraElement {
    ...
    private getHeaderCellClasses(header: ParsedHeader): string {
        ...
        return [
            ...
            header.sortable && !this.disabled ? 'cursor-pointer select-none hover:bg-slate-100 dark:hover:bg-slate-700' : '',
    ...
    private getCheckboxClasses(): string {
        return [
            ...
            'focus:ring-2 focus:ring-sky-500 dark:focus:ring-sky-400 focus:ring-offset-0',
    ...
    private renderCaption(): TemplateResult {
        ...
        return html`
            <caption class="px-4 py-3 text-left text-base font-semibold text-slate-900 dark:text-slate-100 bg-white dark:bg-slate-900">
                ...
                <tr role="row">
                    ${this.selectable
                        ? html`
                              <th
                                  role="columnheader"
                                  class="px-4 py-3 w-12 bg-slate-50 dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700"
                              >
                                  <input
                                      type="checkbox"
    ...
    private renderFooter(): TemplateResult {
        ...
        return html`
            <tfoot role="rowgroup" class="bg-slate-50 dark:bg-slate-800">
    ...
    private renderLoading(): TemplateResult {
        ...
        return html`
            <div class="animate-pulse">
                <div class="bg-slate-50 dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700">
                    <div class="flex px-4 py-3 space-x-4">
                        ${this.selectable
                            ? html`<div class="w-4 h-4 bg-slate-200 dark:bg-slate-700 rounded"></div>`
                            : html``}
                        ${Array(skeletonCols)
                            .fill(0)
                            .map(
                ...
                ${Array(skeletonRows)
                    ...
                    .map(
                        () => html`
                            <div class="flex px-4 py-3 space-x-4 border-b border-slate-100 dark:border-slate-700">
                                ${this.selectable
                                    ? html`<div class="w-4 h-4 bg-slate-100 dark:bg-slate-800 rounded"></div>`
                                    : html``}
                                ${Array(skeletonCols)
                                    .fill(0)
                                    .map(
    ...
    private renderPagination(): TemplateResult {
        ...
        return html`
            <nav
                ...
                class="flex items-center justify-between px-4 py-3 border-t border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900"
            >
    ...
    private renderError(): TemplateResult {
        ...
        return html`
            <div class="px-4 py-2 text-sm text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/20 border-t border-red-200 dark:border-red-800">
