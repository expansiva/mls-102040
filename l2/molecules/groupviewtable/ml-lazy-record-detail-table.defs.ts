...
- Displays the declarative text and supplied components from the record’s cells in its detail row, preserving nested interactive components as functional elements.
...
- Supports only the groupViewTable content areas: Caption, TableHeader, TableBody, TableFooter, Empty, and Loading, with rows and cells in their defined table sections.
...
- The expanded detail content is supplied or updated by the consumer after the expansion request.
