/// <mls fileReference="_102040_/l2/molecules/groupviewhierarchy/ml-hierarchy-tree-diagram.ts" enhancement="_102020_/l2/enhancementAura"/>
// =============================================================================
...
'ml-surface-bg',
'ml-border',
 disabled ?'ml-disabled' :'hover:ml-surface-dim-bg',
'',
 ]
 .filter(Boolean)
 .join(' ');
...
'ml-text',
'',
 disabled ?'ml-disabled' :'cursor-pointer hover:ml-surface-dim-bg',
 ]
 .filter(Boolean)
 .join(' ');
 }
...
'h-3 w-3 rounded-full border',
 ...
 return html`
 <svg class="h-3 w-3 ml-text-muted" viewBox="0 0 20 20" fill="currentColor">
 ${svg`
 <path
 d="M6 8l4 4 4-4"
 stroke="currentColor"
 ...
 return html`
 <div class="${cn('mb-3 text-sm font-semibold ml-text', this.getSlotClass('Label'))}">
