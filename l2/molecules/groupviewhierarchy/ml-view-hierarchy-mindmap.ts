...
'cursor-pointer transition-all duration-200',
 ...
 ?'ml-node-fill-central'
 :'ml-node-fill';
 const strokeClass = isCentral
 ?'ml-node-stroke-central'
 :'ml-node-stroke';
 ...
 class="flex items-center justify-center h-full text-sm text-center overflow-hidden ${isCentral ?'ml-primary-text font-medium' :'ml-text'} ${isDisabled ?'opacity-50' :''}"
 >
 ...
 cy="${y}"
 r="10"
 class="ml-node-toggle ${isDisabled ?'opacity-50' :''}"
 stroke-width="1"
 />
 <text
 x="${x}"
 y="${y + 4}"
 text-anchor="middle"
 class="ml-node-toggle-text text-xs font-bold select-none ${isDisabled ?'opacity-50' :''}"
 ...
 return html`
 <div class="${cn('mb-4 text-lg font-semibold ml-text', this.getSlotClass('Label'))}">
 ...
 : this.msg.empty;
 return html`
 <div class="flex items-center justify-center h-64 ml-text-muted">
 ...
 return html`
 <div class="${cn('flex items-center justify-center h-64', this.cssClass)}">
 <div class="flex flex-col items-center gap-3">
 <div class="w-8 h-8 border-4 ml-border ml-spinner-top rounded-full animate-spin"></div>
 ...
 ${this.renderLabel()}
 <div
 class="relative w-full h-96 ml-surface-dim-bg rounded-lg border ml-border overflow-hidden"
 role="tree"
