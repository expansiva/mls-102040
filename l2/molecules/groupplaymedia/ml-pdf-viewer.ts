...
export class MlPdfViewerMolecule extends MoleculeAuraElement {
  ...
  private getButtonClasses(isDisabled: boolean): string {
    return [
      ...
      isDisabled
        ...
        : 'hover:bg-slate-100 dark:hover:bg-slate-700 cursor-pointer bg-white dark:bg-slate-800',
  ...
  private getActiveButtonClasses(isActive: boolean): string {
    return [
      ...
      isActive
        ...
        : 'text-slate-600 dark:text-slate-400 border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800',
  ...
  private renderLabel(): TemplateResult {
    ...
    return html`
      <div class="px-3 py-2 text-sm font-medium text-slate-700 dark:text-slate-300 border-b border-slate-200 dark:border-slate-700">
  ...
  private renderScaleControls(): TemplateResult {
    ...
    return html`
      <div class="flex items-center gap-1">
        ...
        <span class="text-sm text-slate-600 dark:text-slate-400 min-w-[3rem] text-center">
  ...
  private renderProgressBar(): TemplateResult {
    return html`
      <div class="px-3 py-2 border-t border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900">
        <input
          type="range"
    ...
    return html`
      <div class=${this.getLoadingOverlayClasses()}>
        <div class="flex flex-col items-center gap-3">
          ...
          <span class="text-sm text-slate-600 dark:text-slate-400">${this.msg.loading}</span>
        </div>
      </div>
    `;
  }
