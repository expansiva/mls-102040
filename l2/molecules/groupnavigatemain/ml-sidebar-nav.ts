...
'',
 isActive
 ?'ml-primary-dim-bg ml-primary-text'
 :'ml-text',
 !isActive && !isDisabled
 ?'hover:ml-surface-dim-bg hover:ml-text'
 :'',
...
'flex h-5 w-5 flex-shrink-0 items-center justify-center',
 isActive
 ?'ml-primary-text'
 :'ml-text-faint group-hover:ml-text-muted',
 ].join(' ');
 }
 ...
 return html`
 <span class="${this.getIconClasses(item)} rounded-md ml-surface-dim-bg text-xs font-bold">
 ${initials}
 </span>
 `;
 }
 ...
 ${item.badge ? html`
 <span class="ml-auto inline-flex items-center rounded-full ml-primary-dim-bg px-2 py-0.5 text-xs font-semibold ml-primary-text">
 ${item.badge}
 </span>
 ` : nothing}
 ` : html`
 ${item.badge ? html`
 <span class="absolute right-1.5 top-1.5 h-2 w-2 rounded-full ml-error-dim-bg"></span>
 ` : nothing}
 `}
 </button>
 `;
 ...
 return html`
 <div class="space-y-1">
 <div class="mx-3 my-2 h-px ml-surface-dim-bg"></div>
 ...
 ${group.label ? html`
 <button
 class="flex w-full items-center justify-between px-3 py-1.5 text-xs font-semibold uppercase tracking-wider ml-text-faint hover:ml-text-muted transition"
 type="button"
 ...
 return html`
 <button
 class="flex items-center justify-center rounded-lg p-1.5 ml-text-faint hover:ml-surface-dim-bg hover:ml-text-muted transition"
 type="button"
 ...
 <div class="h-5 w-5 flex-shrink-0 rounded ml-surface-dim-bg"></div>
 ${!this.collapsed ? html`
 <div class="h-3 w-28 rounded ml-surface-dim-bg"></div>
 ` : nothing}
 </div>
 `)}
 <div class="mx-3 my-3 h-px ml-surface-dim-bg"></div>
 ${[1, 2].map(() => html`
 <div class="flex items-center gap-3 rounded-lg px-3 py-2">
 <div class="h-5 w-5 flex-shrink-0 rounded ml-surface-dim-bg"></div>
 ${!this.collapsed ? html`
 <div class="h-3 w-20 rounded ml-surface-dim-bg"></div>
 ` : nothing}
 </div>
 `)}
 </div>
 ...
 return html`
 <nav
 class="${cn(`${sidebarWidth} flex h-full flex-col overflow-hidden border-r ml-border ml-surface-bg transition-all duration-200`, this.cssClass)}"
 aria-label=${labelContent || this.msg.navigation}
 >
 <!-- Header: label + collapse toggle -->
 <div class="flex min-h-[56px] items-center justify-between border-b ml-border px-3 py-3">
 ${!this.collapsed && labelContent ? html`
 <span class="${cn('truncate text-sm font-semibold ml-text', this.getSlotClass('Label'))}">
 ...
 <div class="border-t ml-border px-2 py-3 space-y-1">
